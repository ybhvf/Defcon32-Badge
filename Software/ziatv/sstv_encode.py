...
class Encode_SSTV():
    ...
    def write_vox(self):
        # Vox
        print("Writing vox")
        self.write_signal(1900, 0.100); # 127
        self.write_signal(1500, 0.100); # 0
        self.write_signal(1900, 0.100); # 127
        self.write_signal(1500, 0.100); # 0
        self.write_signal(2300, 0.100); # 255
        self.write_signal(1500, 0.100); # 0
        self.write_signal(2300, 0.100); # 255
        self.write_signal(1500, 0.100); # 0
    ...
    def write_vis(self):
        # VIS
        print("Writing vis")
        self.write_signal(1200, .030) # START
        self.write_signal(1300, .030) # 0
        self.write_signal(1300, .030) # 0
        self.write_signal(1100, .030) # 1
        self.write_signal(1100, .030) # 1
        self.write_signal(1100, .030) # 1
        self.write_signal(1100, .030) # 1
        self.write_signal(1300, .030) # 0
        self.write_signal(1300, .030) # 1 (parity)
        self.write_signal(1200, .030) # STOP
